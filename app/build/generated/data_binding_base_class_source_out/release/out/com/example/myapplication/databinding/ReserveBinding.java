...
public final class ReserveBinding implements ViewBinding {
  ...
  private ReserveBinding(@NonNull RelativeLayout rootView, @NonNull RecyclerView recyclerview) {
  ...
  public static ReserveBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ReserveBinding((RelativeLayout) rootView, recyclerview);
    }
